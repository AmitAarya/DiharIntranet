...
public class RegisterNewStoreDao {
	public boolean isStoreRegistered(String userId, String userName, String userGender, String userDesignation,
		...
		try {
			...
			if (i > 0) {
				int j = dbcon.executeUpdate(dbcon.getConnection(), "insert into store_master values(?,?,?,?,?,?,?,?,?)",
