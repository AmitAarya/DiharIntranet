...
<header>
        ...
        <td><h2>WELCOME: </h2></td>
<td></h2><input type="text" value="<%= session.getAttribute("username") %>" /></h2></td>
...
<!-- END OUTPUT from 'modules/system/region.tpl.php' -->
  ...
  <div class="col-md-8 col-xs-8 col-sm-8">
      <h1 class="logo"><a href="http://localhost:8085/DiharIntranet/"><strong>रक्षा उच्च तुंगता अनुसंधान  संस्थान</strong> <span>DEFENCE INSTITUTE OF HIGH ALTITUDE RESEARCH</span></a></h1>        
    </div>
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <div id="main-menu">
                    <ul class="menu nav"><li class="first leaf active"><a href="http://192.168.0.79:8085/DiharIntranet/diharhome.jsp" title="" class="active"><i class="fa fa-home"></i></a></li>
<li class="expanded dropdown active"><a href="http://www.upsc.gov.in/" title="" data-target="#" class="dropdown-toggle active" data-toggle="dropdown">LEAVE<span class="caret"></span></a><ul class="dropdown-menu"><li class="first leaf fontSize" style="font-size: 100%;"><a href="http://192.168.0.79:8085/DiharIntranet/ApplyForLeave.jsp">Apply For LEAVE</a></li>

</ul></li>
<li class="expanded dropdown active"><a href="http://www.upsc.gov.in/" title="" data-target="#" class="dropdown-toggle active" data-toggle="dropdown">TD<span class="caret"></span></a><ul class="dropdown-menu"><li class="first leaf fontSize" style="font-size: 100%;"><a href="http://192.168.0.79:8085/DiharIntranet/RegisterNewDirector.jsp" title="">Apply For TD</a></li>


</ul></li>
<li class="expanded dropdown active"><a href="http://www.upsc.gov.in/" title="" data-target="#" class="dropdown-toggle active" data-toggle="dropdown">CASH PURCHASE<span class="caret"></span></a><ul class="dropdown-menu"><li class="first leaf fontSize" style="font-size: 100%;"><a href="http://192.168.0.79:8085/DiharIntranet/RegisterNewAdmin.jsp" title="">Apply For CASH PURCHASE</a></li>
         ...
         select TXN_ID,TXN_DATE,TXN_APPLICANT_ID,TXN_TYPE from txn_master where txn_hod_id='<%= session.getAttribute("userId") %>' order by txn_id desc
					...
					<div align="center">
						<table border="1" cellpadding="5">
							...
							<c:forEach var="txndata"
								items="${txndata.rows}">
								<tr>
								    <tr>
									<html:form action="/txnfiledownload" focus="txn_id">

										<!-- <td><c:out value="${notificationdata.noti_id}" /></td> -->
										<td><input type="hidden" name="txn_id" value="${txndata.txn_id}" height="1" width="1"></td>

										<td><c:out value="-->${txndata.txn_date}" /></td>
										<td><c:out value="${txndata.txn_applicant_id}" /></td>
										<td><font colour="blue"><c:out value="${txndata.txn_type}" /></font></td>
										
										<td>
											<button type="submit" class="login__submit"
												value="txnfiledownload"><font color="red">DOWNLOAD</font></button>
										</td>
									  ...
									  <td><html:form action="/txnfilereturn" focus="txn_id" enctype="multipart/form-data">
                                                       
                                                       <td><input type="hidden" name="txn_id"
														value="${txndata.txn_id}" height="1" width="1"></td>
														
														<h4>Remarks :</h4>
				                                       <html:text property="returnremarks" />
													<div class="file-chooser">
														<!--  <input class="file-chooser__input" type="file">-->
...
<div class="notificationdemo" style="font-size: 100%;">
<div class="login">
	<div class="whats-new-welcome fontSize" style="font-size: 90%;">
