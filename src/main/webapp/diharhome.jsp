...
<body class="html front not-logged-in two-sidebars page-node i18n-en"
	...
	<div id="skip-link">
		<a href="http://www.upsc.gov.in/#main-content"
...
-->
			...
			<section id="block-cmf-content-header-region-block"
				class="block block-cmf-content clearfix">


			<noscript class="no_scr">"JavaScript is a standard
				programming language that is included to provide interactive
				features, Kindly enable Javascript in your browser. For details
				...
				<div class="container common-container">
					<div class="top-search">
						<ul>
							<li><form class="form-search content-search"
									action="http://www.upsc.gov.in/" method="post"
										...
										<div>
											...
											<div class="input-group">
												<input title="Enter the terms you wish to search for."
													...
													value="" size="15" maxlength="128"><span
													class="input-group-btn"><button type="submit"
														class="btn btn-default">Search</button></span>
											</div>
											<button class="element-invisible btn btn-primary form-submit"
												id="edit-submit" name="op" value="Search" type="submit">Search</button>
											<input type="hidden" name="form_build_id"
												value="form-DrJNQqORL0FJvvVcdORGR44NhkGZBlrFLxXBbldaD8g">
					...
					<div class="common-right clearfix">
						<ul id="header-nav">
							...
							<li><a onclick="set_font_size(&#39;decrease&#39;)"
								title="Decrease font size" href="javascript:void(0);">A<sup>-</sup></a>
							</li>
							<li><a href="javascript:void(0);" class="high-contrast dark"
								title="High Contrast">A</a></li>
...
/*--><!]]>*/
	...
	<!-- /.container--> </section> <section class="slider-section">
...
-->
			<!-- BEGIN OUTPUT from 'sites/all/themes/bootstrap/theme/block/block.tpl.php' -->
			<section id="block-views-main-slider-block"
				class="block block-views clearfix"> <!-- THEME DEBUG --> <!-- CALL: theme('views_view') -->
			<!-- BEGIN OUTPUT from 'sites/all/modules/contributed/views/theme/views-view.tpl.php' -->
			<div
				class="view view-main-slider view-id-main_slider view-display-id-block view-dom-id-9afd1ddd7f4218a76d72f5949765ac54">
				...
				<div class="view-content">
					...
					<div id="views-bootstrap-carousel-1"
						class="views-bootstrap-carousel-plugin-style carousel slide">
						<!-- Carousel indicators -->
						<ol class="carousel-indicators">
							<li data-target="#views-bootstrap-carousel-1" data-slide-to="0"
								class=""></li>
							<li data-target="#views-bootstrap-carousel-1" data-slide-to="1"
								class=""></li>
							<li data-target="#views-bootstrap-carousel-1" data-slide-to="2"
								class="active"></li>
							<li data-target="#views-bootstrap-carousel-1" data-slide-to="3"
								class=""></li>
							<li data-target="#views-bootstrap-carousel-1" data-slide-to="4"
								class=""></li>
						</ol>
						...
						<div class="carousel-inner">
							<div class="item">
								...
								<img typeof="foaf:Image"
									src="./Welcome to UPSC _ UPSC_files/slider1.jpg" width="1920"
									height="413" alt="">
							...
							<div class="item">
								...
								<!-- BEGIN OUTPUT from 'sites/all/modules/contributed/views_bootstrap/templates/carousel/views-bootstrap-carousel-plugin-rows.tpl.php' -->
								<img typeof="foaf:Image"
									src="./Welcome to UPSC _ UPSC_files/slider2.jpg" width="1920"
									height="413" alt="">
							...
							<div class="item active">
								...
								<!-- BEGIN OUTPUT from 'sites/all/modules/contributed/views_bootstrap/templates/carousel/views-bootstrap-carousel-plugin-rows.tpl.php' -->
								<img typeof="foaf:Image"
									src="./Welcome to UPSC _ UPSC_files/slider6.jpg" width="1920"
									height="413" alt="">
							...
							<div class="item">
								...
								<!-- BEGIN OUTPUT from 'sites/all/modules/contributed/views_bootstrap/templates/carousel/views-bootstrap-carousel-plugin-rows.tpl.php' -->
								<img typeof="foaf:Image"
									src="./Welcome to UPSC _ UPSC_files/slider4.jpg" width="1920"
									height="413" alt="UPSC">
							...
							<div class="item">
								...
								<!-- BEGIN OUTPUT from 'sites/all/modules/contributed/views_bootstrap/templates/carousel/views-bootstrap-carousel-plugin-rows.tpl.php' -->
								<img typeof="foaf:Image"
									src="./Welcome to UPSC _ UPSC_files/slider5.jpg" width="1920"
									height="413" alt="">
						...
						<a class="carousel-control left"
							href="http://www.upsc.gov.in/#views-bootstrap-carousel-1"
...
-->
					...
					<div class="region region-help alert alert-info">
						<i class="icon glyphicon glyphicon-question-sign"
							aria-hidden="true"></i>
...
-->
						...
						<p>
							<img alt="image" src="./Welcome to UPSC _ UPSC_files/alert.png">
							<marquee
								style="display: inline-block; width: 80%; vertical-align: middle;">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
									href="http://192.168.0.79:8085/DiharIntranet/notification/TaDaClaimLimit.pdf"
	...
	<section class="related-link-region container fontSize"
		style="font-size: 100%;"> </section>
...
-->
			<!-- BEGIN OUTPUT from 'sites/all/themes/bootstrap/theme/block/block.tpl.php' -->
			<section id="block-cmf-content-footer-region-block"
				class="block block-cmf-content clearfix"> <footer
...
-->
	...
	<script
		src="./Welcome to UPSC _ UPSC_files/js_B2uv6dkjoYobfQVyuXdchgrpnnx4oM0TkP_bDVf8Qrg.js.download"></script>
