	...
	<div class="container header-container">
		<div class="row">
			<div class="col-md-8 col-xs-8 col-sm-8">
				<h1 class="logo">
					<a href="http://localhost:8085/DiharIntranet/"><strong>रक्षा
							उच्च तुंगता अनुसंधान संस्थान</strong> <span>DEFENCE INSTITUTE OF
							HIGH ALTITUDE RESEARCH</span></a>
				</h1>
			</div>
				...
				<div id="main-menu">
					<ul class="menu nav">
						<li class="first leaf active"><a
							...
							title="" class="active"><i class="fa fa-home"></i></a></li>
						...
						<ul class="dropdown-menu">
								<li class="first leaf fontSize" style="font-size: 100%;"><a
									href="http://192.168.0.79:8085/DiharIntranet/RegisterNewDirector.jsp"
						...
						<ul class="dropdown-menu">
								<li class="first leaf fontSize" style="font-size: 100%;"><a
									href="http://192.168.0.79:8085/DiharIntranet/RegisterNewAdmin.jsp"
	...
	<div class="demo">
		<div class="login">
			...
			<html:form action="/fileupload" focus="noti_heading"
				...
				<h4>HEADING :</h4>
				<html:text property="noti_heading" />
				<h4>TYPE :</h4>
	...
	<div class="inboxdemo">
		<div class="login">
			<div class="whats-new-welcome fontSize" style="font-size: 90%;">
				...
				<h5>
					<font color="#cc9900"> <b>|----DATE-----|---APPLIED
							BY---|---TXN TYPE----|---DOWNLOAD----|</b></font>
				</h5>
	...
	<div class="notificationdemo" style="font-size: 100%;">
		<div class="login">
			<div class="whats-new-welcome fontSize" style="font-size: 90%;">
				...
				<h5>
					<font color="#cc9900"> <b>|-----------HEADING---------|--------TYPE--------|----DOWNLOAD-----|</b></font>
				</h5>
